    ...
    items: [
      {
        ...
        answer:
          "HEX, RGB, HSL, and OKLCH inputs are parsed and converted between all supported formats.",
      },
      {
        question: "Can I generate a related palette?",
        answer:
          "Yes, the tool can generate related palette variations from any valid base color, including OKLCH values.",
      },
    ],
  },
  "/tools/data/yaml": {
