      ...
      <ToolCard>
        ...
        <ToolBody className="space-y-4 pt-3">
          <div className="flex flex-wrap items-center gap-1.5">
            <ToolMeta className="w-24 shrink-0 mr-1">Quick Zones</ToolMeta>
...
function FormatRow({ label, value }: { label: string; value: string }) {
  return (
    <div className="flex items-center justify-between px-3 py-2.5">
      ...
      <div className="flex items-center gap-2">
        <span className="font-mono text-[14px] text-foreground">{value}</span>
        <CopyButton text={value} className="h-7 px-2 text-[12px]" />
      </div>
    </div>
  );
}
