        ...
        >
          <div className="flex flex-wrap items-start justify-between gap-5">
            <div className="max-w-2xl">
              ...
              <div className="mt-4 flex flex-wrap items-center gap-2">
                <Link
                  href="#popular-tools"
                  className="inline-flex min-h-10 items-center gap-1.5 rounded-md border border-border bg-background px-3 text-[13px] font-medium text-foreground transition-colors hover:bg-muted focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
                >
                  Quick start tools
                  <FontAwesomeIcon
                    icon={faChevronRight}
                ...
                <Link
                  href="#all-tools"
                  className="inline-flex min-h-10 items-center rounded-md border border-border px-3 text-[13px] font-medium text-muted-foreground transition-colors hover:bg-muted hover:text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background"
                >
                  Browse all tools
                </Link>
              </div>
          ...
          <div className="mt-5 flex flex-wrap gap-2 border-t border-border pt-4">
            {categorySummary.map((group) => (
              <span
                key={group.name}
                className="inline-flex min-h-8 items-center rounded-full border border-border bg-background px-2.5 text-[12px] font-medium text-muted-foreground"
              >
                {group.name}
